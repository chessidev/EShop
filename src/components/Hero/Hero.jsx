...
const Hero = () => {
  return (
    <section className="container">
      <div className="flex items-center justify-center min-h-[550px] sm:min-h-[650px] rounded-3xl dark:from-gray-900 from-gray-300 to-gray-100 bg-gradient-to-r dark:to-gray-800">
